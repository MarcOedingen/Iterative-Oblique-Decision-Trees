...
if __name__ == "__main__":
    ...
    print(
        "----------------------Starting experiment for MountainCarContinuous-v0 Iterative samples with CART----------------------"
    )
    for i in range(numb_runs):
        time_start_run = time.time()
        base_samples, rewards = o_utils.evaluate_oracle_mcc_steps(
    ...
    p_utils.save_results("MountainCarContinuous-v0", rewards_cart, rewards_oracle, method="ITER_CART")
    ...
    p_utils.save_timings_samples(
        time_run, time_cart, samples_cart, env_name="MountainCarContinuous-v0", method="ITER_CART"
    )
