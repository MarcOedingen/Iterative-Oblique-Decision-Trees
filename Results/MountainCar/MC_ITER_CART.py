...
if __name__ == "__main__":
    ...
    print(
        "----------------------Starting experiment for MountainCar-v0 Iterative samples with CART----------------------"
    )
    ...
    p_utils.save_results("MountainCar-v0", rewards_cart, rewards_oracle, method="ITER_CART")
    ...
    p_utils.save_timings_samples(
        time_run, time_cart, samples_cart, env_name="MountainCar-v0", method="ITER_CART"
    )
