...
if __name__ == "__main__":
    ...
    print(
        "----------------------Starting experiment for LunarLander-v2 Iterative samples with OPCT----------------------"
    )
    ...
    p_utils.save_results("LunarLander-v2", rewards_opct, rewards_oracle, method="ITER")
    ...
    p_utils.save_timings_samples(
        time_run, time_opct, samples_opct, env_name="LunarLander-v2", method="ITER"
    )
