...
if __name__ == "__main__":
    ...
    print(
        "----------------------Starting experiment for CartPole-v1 Iterative samples with CART----------------------"
    )
    ...
    p_utils.save_results("CartPole-v1", rewards_cart, rewards_oracle, method="ITER_CART")
    ...
    p_utils.save_timings_samples(
        time_run, time_cart, samples_cart, env_name="CartPole-v1", method="ITER_CART"
    )
